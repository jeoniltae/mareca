'use client'
// 마스터스 오픈강좌 게시글 수정/삭제 액션 버튼 컴포넌트
...
import { deleteOpenLecture } from './actions'

type DialogType = 'edit' | 'delete' | null

interface OpenLectureActionsProps {
  id: string
}

export function OpenLectureActions({ id }: OpenLectureActionsProps) {
