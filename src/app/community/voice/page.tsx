...
function PostRow({ post, isPinned, rowNumber }: PostRowProps) {
  ...
  return (
    <Link href={`/community/voice/${post.id}`} className={cn("group py-3.5 px-2 -mx-2 rounded-lg hover:bg-slate-50 transition-colors flex sm:hidden flex-col gap-1.5", isPinned && "bg-slate-50/80 hover:bg-slate-100/80")}>
