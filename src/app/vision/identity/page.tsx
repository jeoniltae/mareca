...
export const metadata: Metadata = {
  ...
  openGraph: { title: '우리는 누구인가?', description: '마스터스개혁파총회의 정체성과 신학적 입장을 소개합니다.', url: `${process.env.NEXT_PUBLIC_SITE_URL}/vision/identity`, images: [OG_IMAGE] },
  alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL}/vision/identity` },
}
