...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL}/news/notice/${id}` },
  }
}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 pb-5 border-b border-slate-200">
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            {(isAuthor || isAdmin) && <PostActions id={id} basePath="/news/notice" />}
          </div>
        </div>
        ...
        <ViewTracker id={id} boardPath="/news/notice" />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(
              articleJsonLd({
                ...
                url: `${process.env.NEXT_PUBLIC_SITE_URL}/news/notice/${id}`,
